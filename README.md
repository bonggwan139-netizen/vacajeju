...
<head>
  ...
  <title>함덕 레드브릭 스테이 | 예약</title>
  <meta name="description" content="제주 함덕해수욕장 인근, 붉은 벽돌·민트 포인트의 신축 스테이. 공식 예약은 구글폼으로 접수." />
  <meta property="og:title" content="함덕 레드브릭 스테이 | 예약" />
  <meta property="og:description" content="제주 함덕해수욕장 인근, 붉은 벽돌·민트 포인트의 신축 스테이. 공식 예약은 구글폼으로 접수." />
  <meta property="og:type" content="website" />
  <meta name="theme-color" content="#8a2b2b" />
  <!-- 우아한 세리프 느낌을 위한 가벼운 웹폰트 -->
  <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;600&family=Pretendard:wght@400;600;700&display=swap" rel="stylesheet" />
  <style>
    :root{
      --brick:#8a2b2b;        /* 레드브릭 */
      --brick-dark:#6e1f1f;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      font-family: "Pretendard", ui-sans-serif, system-ui, -apple-system, "Apple SD Gothic Neo", "Noto Sans KR", "Segoe UI", Roboto, "Helvetica Neue", Arial, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif;
      line-height:1.6;
    }
    ...
    /* ===== Splash (Intro) ===== */
    .splash{position:fixed; inset:0; background:var(--cream); display:grid; place-items:center; z-index:999; transition:transform .9s cubic-bezier(.22,.61,.36,1), opacity .6s}
    .splash.hide{transform:translateY(-100%); opacity:0; pointer-events:none}
    .splash-inner{width:min(940px, 86vw);}
    .wordmark{font-family:"Cormorant Garamond", serif; font-weight:600; letter-spacing:.28em; fill:#1b1b1b}
    .tagline{font-family:"Pretendard", ui-sans-serif; fill:#404246; opacity:.85}
    .wave{stroke:#fff; stroke-width:8; fill:none; filter: drop-shadow(0 6px 16px rgba(0,0,0,.08))}
    .draw{stroke-dasharray:1800; stroke-dashoffset:1800; animation:dash 1.8s ease forwards .15s}
    .fadein{opacity:0; animation:fade .9s ease forwards .45s}
...
<body>
  <!-- Intro Splash with Custom Wordmark -->
  ...
  <!-- Mini floating logo appears after splash -->
  ...
  <main>
    ...
    <section id="gallery" class="container">
      ...
      <p style="color:var(--muted); margin-top:10px">* 이미지는 Pexels 무료 라이선스(상업용 사용 가능)를 기반으로 임시 삽입했습니다. 실제 촬영 컷으로 교체 권장.</p>
    </section>
